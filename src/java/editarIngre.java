 ...
 * @author HP
 */
public class editarIngre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String numPlat,nomIngrediente,porIngrediente,uni ,Idingre;
            ...
            Idingre= request.getParameter("idIngred");
            ...
            if (met.valIngre(id)==id) {
                        int estatus = met.actualizarIngrediente(bI,id);
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet editarIngre</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet editarIngre at " + id + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
