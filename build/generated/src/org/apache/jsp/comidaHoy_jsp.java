...
public final class comidaHoy_jsp extends org.apache.jasper.runtime.HttpJspBase
...
out.print(nombredelplatillo); 
      ...
      out.write("                                                                        ");
                                                                            ...
                                                                            for (int ip = 0; ip < met.Ingredientes(nombredelplatillo).size() ; ip++) {
                                                                                    String ie=String.valueOf(met.Ingredientes(nombredelplatillo).get(ip));
                                                                                    
                                                                                    String por=String.valueOf(met.Porcion(nombredelplatillo).get(ip));
