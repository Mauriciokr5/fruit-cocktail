<%-- 
    Document   : asistencia
    Created on : 1/06/2018, 06:58:10 PM
    Author     : Alumno
--%>
...
<html>
    ...
    <body style="background-color: black; color: white;">
        ...
        <div id="asis" style="display: block;" align="center">
            ...
            <h3 >Asistencia</h3>
            Ingrese la asistencia del dia de hoy <%out.print(fecha_bd);%> :<br><br>
            
            
            <form method="post" action="setAsistencia">
                <input type="hidden" name="fecha" value="<%out.print(fecha_bd);%>">
                <input style="color:black;" name="as" id="asistencia" type="text" onkeypress="return validarn(event)" maxlength="3" >
                <br>
